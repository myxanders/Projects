...
<?php
include('sql.php'); //We need sql.php to run this page
...
<body>
	<div class="absolute" id="content">
		<div class="absolute" id="box">
			...
			<form id = "main" action="verify.php" method="post">
				<!-- This sends the completed form to verify once the button is pressed. -->
				<div id="form">
					<label>Full Name: </label><input type="text" name="Name" required="required" autofocus="autofocus"> <br> <br>
					<!--You insert your full name into a textbox.-->
					<label>CWID: </label><input type="text" name="CWID" required="required" maxlength="8"> <br> <br>
					<!--You insert your CWID into a textbox-->
					<label>Gender: </label><input type="radio" name="Gender" required="required" value="Male"> M
					<!-- This creates radio buttons for the male and female gender-->
					...
					<!--This creates radio buttons to adjust your Special Needs Preferences-->
					...
					<!--This defaults the selection to "No Preference"-->
					<label>On-Site Laundry? </label><input type="radio" name="Laundry" value="Yes"> Y
					<!--This creates radio buttons to adjust your Laundry Preferences-->
					...
					<!--This creates radio buttons to adjust your Kitchen Preferences-->
					...
					<label>Class Year: </label><select name="Class">
						<!-- We added a dropdown bar for you to pick which class you're in-->
					...
					<label>Preferred Residential Area: </label><select name="PrefResArea">
						<!-- This is where you pick where you want to live-->
						<option value="No Preference">~~No Preference~~</option>
						<!--If you're not sure yet, this option is defaulted and suggests residence areas on the next page-->
						<?php
					...
					<!--You have to submit the form before you can move on-->
			</form>
		</div>
	</div>
	</div>
