...
<html>
	<head>
		...
		<title>EFL Championship (Second Level) History</title>
	...
	<body>
		...
		<h1 align="center"><a href='../Championship' style="text-decoration: none; color: white;">EFL Championship Winners</a></h1>
		<div class="history" align="center" style="margin-top: 10px">
			<table align="center" id="bowls">
				<tr>
                    ...
                    <th style="width: 250px; text-align: center;">3rd/Playoff Winner</th>
				</tr>
				<?php
				$i=1;
